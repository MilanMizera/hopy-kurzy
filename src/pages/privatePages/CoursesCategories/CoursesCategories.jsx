...
const CoursesCategories = () => {
    ...
    return (<div className="all-wrapper-courses-categories">
                                ...
                                <div class="card h-100">
                                    ...
                                    <div class="card-body" id="courses-categories-card-body">
                                        ...
                                        <div className="private-courses-info-wrapper">
                                            ...
                                            <div className="row-for-buttons-private-courses-categories">
                                                <div className="col-1-for-buttons-private-courses-categories">
                                                    <Link className="courses-categories-view-button">Zobrazit kurz</Link>
                                                </div>
                                                <div className="col-1-for-buttons-private-courses-categories">
                                                    <Link className="courses-categories-buy-button">Zakoupit</Link>
                                                </div>
